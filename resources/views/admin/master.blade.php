  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <form action="{{ route('logout') }}" method="post">
            @csrf
            <input class="bg-gray-50 px-2 py-1 transition-all duration-500 text-blue-700 hover:bg-black hover:text-white hover:rounded-md mr-4" type="submit" value="Logout">
        </form>
